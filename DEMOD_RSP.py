...
class DEMOD_RSP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DEMOD_RSP")
        ...
        self.ATTEN_1 = ATTEN_1 = 0

        ##################################################
        # Blocks
        ##################################################
        self._rfgain_slider_range = Range(0, 100, 1, 36, 200)
        self._rfgain_slider_win = RangeWidget(self._rfgain_slider_range, self.set_rfgain_slider, "RF Gain (Inverse Gain)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, int((samp_rate*2)/5),True)
        self._ATTEN_1_range = Range(0, 40, 1, 0, 200)
        self._ATTEN_1_win = RangeWidget(self._ATTEN_1_range, self.set_ATTEN_1, "LNA Attenuation", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ATTEN_1_win)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle_0.set_sample_rate(int((self.samp_rate*2)/5))
    ...
    def get_ATTEN_1(self):
        return self.ATTEN_1

    def set_ATTEN_1(self, ATTEN_1):
        self.ATTEN_1 = ATTEN_1




def main(top_block_cls=DEMOD_RSP, options=None):
