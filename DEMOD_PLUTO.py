...
class DEMOD_PLUTO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DEMOD_PLUTO")
        ...
        self.samp_rate = samp_rate = int(3e6)
        ...
        # Blocks
        ##################################################
        self._rfgain_slider_range = Range(0, 72, 1, 36, 200)
        ...
        self.iio_pluto_source_0.set_frequency(int(target_freq))
        self.iio_pluto_source_0.set_samplerate(samp_rate)
        self.iio_pluto_source_0.set_gain_mode(0, 'manual')
        self.iio_pluto_source_0.set_gain(0, 36)
        self.iio_pluto_source_0.set_quadrature(True)
        self.iio_pluto_source_0.set_rfdc(True)
        self.iio_pluto_source_0.set_bbdc(True)
        self.iio_pluto_source_0.set_filter_params('Auto', '', 0, 0)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, int((samp_rate*2)/3),True)
    ...
    def set_target_freq(self, target_freq):
        ...
        self.iio_pluto_source_0.set_frequency(int(self.target_freq))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle_0.set_sample_rate(int((self.samp_rate*2)/3))
...
def main(top_block_cls=DEMOD_PLUTO, options=None):
